class Protagonist {
    ...
    // Custom method for drawing the object
     ...
     hud(){
      ...
      fill(50, 50, 50, 200);
      rect(width / 2 - 105, (height * 0.2) - 50, 210, 30); // BAR OUTLINE
      arc(width / 2 - 105, (height * 0.2) - 50 + 15, 30, 30, HALF_PI, PI + HALF_PI);
      arc(width / 2 + 105, (height * 0.2) - 50 + 15, 30, 30, -HALF_PI, HALF_PI);
      ...
      for (let x = -4; x < 4; x++) {
        for (let y = -4; y < 4; y++) {
          text("LEVEL  " + this.level, (width / 2) + x, (height * 0.2) - 60 + y);
        }
      }
      fill(255);
      for (let x = -2; x < 2; x++) {
      ...
      if (this.xpIncrement < this.xp) {
        ellipse(width / 2 - 105, (height * 0.2) - 45 + 10, 20, 20);
        rect(
          width / 2 - 105,
          (height * 0.2) - 45,
        ...
        rect(width / 2 - 105, (height * 0.2) - 45, 200.0 * (this.xp / this.levelRequirements), 20);
        ellipse(width / 2 - 105, (height * 0.2) - 45 + 10, 20, 20);
        ellipse(
