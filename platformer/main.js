...
class Background {
  ...
  display() {
    ...
    image(grove, (width / 11) + this.world2ScreenX(windowWidth, 1), height / 6, width / 3, height / 3);
    image(newgame, (width / 9) + this.world2ScreenX(windowWidth, 1), height / 2.4, width / 5, height / 5);
    image(ret, (width / 9) + this.world2ScreenX(windowWidth, 1), height / 2, width / 5, height / 5);
  }
}
